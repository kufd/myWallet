<div class="login">
	...
	<p class="about">
		<?php echo __('Сервіс який допоможе підсумувати ваші витрати.'); ?>
		<a href="#" <?php echo Ga::getTrackEventCode('About', 'Click link show about'); ?>>
			<?php echo __('Більше інформації.'); ?>
		</a>
	</p>
